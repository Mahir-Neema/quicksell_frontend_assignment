        ...
        <div className="list-container">
            <div className="list-header">
                <div className="table-header-left">
                    {
                        {
                            'status' : <>{
                                {
                                    'Backlog': <div className="table-icon">
                                    ...
                                    'In progress': <div className="table-icon">
                                    ...
                                    'Cancelled': <div className="table-icon">
                    ...
                    <div className="table-sum">{cardCount}</div>
                </div>
            ...
            <div className="table-card-items">
                {
